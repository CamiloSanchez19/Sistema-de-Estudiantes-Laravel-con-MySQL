...
<form method="POST"
    ...
    <div class="bg-slate-100 p-6 rounded-xl shadow-sm space-y-4">
        ...
        <div>
            ...
            <input type="password"
                   name="password"
                   placeholder="Digita la nueva contraseña si deseas cambiarla"
                   class="w-full rounded-lg border px-3 py-2
                          focus:ring-indigo-500 focus:border-indigo-500
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="sexo"
                        class="w-full rounded-lg border px-3 py-2">
                    <option value="M" @selected(old('sexo', $estudiante->sexo) == 'M')>
                        Masculino
                    </option>
                    <option value="F" @selected(old('sexo', $estudiante->sexo) == 'F')>
                        Femenino
                    </option>
                </select>
            </div>
    ...
    <div class="flex gap-4">
        <button type="submit"
            class="flex-1 bg-indigo-600 text-black py-3 rounded-xl
