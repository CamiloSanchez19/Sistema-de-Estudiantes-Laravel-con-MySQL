            ...
            <div class="relative flex flex-col lg:flex-row items-center justify-between gap-8">
                ...
                <div>
                    ...
                    <p class="mt-4 text-black/70 text-xl font-bold max-w-2xl leading-relaxed">
                        ...
                        Crea nuevos cursos académicos
                        de manera rápida, divertida
                        y organizada ✨
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-[35px]
            ...
            <div class="bg-gradient-to-r from-pink-100 via-sky-100 to-yellow-100
                ...
                <p class="text-slate-600 font-bold mt-2">
                    Completa los datos para registrar un nuevo curso
                </p>
            ...
            <form method="POST"
                ...
                <div>
                    ...
                    <label for="nombre_curso"
                           class="block text-black font-black mb-3">
                    ...
                    <input type="text"
                           ...
                           class="w-full rounded-2xl border-2 border-pink-100
                                  ...
                                  @error('nombre_curso') border-red-400 @enderror">
